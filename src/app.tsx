      ...
      <div className="max-w-3xl w-full px-6 text-center space-y-10">
        ...
        <div className="space-y-4">
          <div className="h-16 bg-zinc-900 px-4 rounded-xl flex items-center shadow-shape gap-3">
            ...
            <button onClick={openGuestsInput} className="bg-lime-300 text-line-950 rounded-lg px-5 py-2 font-medium flex items-center gap-2 hover:bg-lime-400">
              Continuar
        ...
        {isGuestsInputOpen && (
          ...
          <button type="button" onClick={openGuestsModal} className="flex items-center gap-2 flex-1 text-left">
            ...
            <span className="text-zinc-400 text-lg flex-1 le">Quem estará na viagem?</span>
          </button>

          <div className="w-px h-6 bg-zinc-800"/>

          <button className="bg-lime-300 text-line-950 rounded-lg px-5 py-2 font-medium flex items-center gap-2 hover:bg-lime-400">
            Confirmar viagem
            <ArrowRight className="size-5"/>
          </button>
        </div>)}</div>
     ...
     <div className="fixed inset-0 bg-black/60 flex items-center justify-center">
        <div className="w-[640px] rounded-xl py-5 px-6 shadow-shape bg-zinc-900 space-y-5">
          ...
          <div className="flex items-center justify-between">
            <h2 className="text-lg front-semibold">Selecionar convidados</h2>
